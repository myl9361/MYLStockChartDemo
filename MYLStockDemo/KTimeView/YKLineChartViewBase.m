              ...
              lineWidth:(CGFloat)lineWidth
{
    ...
    [self drawLabel:context attributesText:leftMarkerStrAtt rect:CGRectMake(0,point.y - leftMarkerStrAttSize.height/2.0-leftMarkerStrAttSize.height/2, leftMarkerStrAttSize.width, leftMarkerStrAttSize.height)];
    ...
    CGRect rect = CGRectMake(point.x - bottomMarkerStrAttSize.width/2.0,  self.contentTop, bottomMarkerStrAttSize.width, bottomMarkerStrAttSize.height);
